...
enum EServerResponses {
  ...
  VIDEOS_UPDATE_IS_NULL = "VIDEOS_UPDATE_IS_NULL",
  VIDEOS_UPDATE_ERROR = "VIDEOS_UPDATE_ERROR",
  VIDEOS_UPDATE_SUCCESSFUL = "VIDEOS_UPDATE_SUCCESSFUL",
  VIDEOS_UPLOAD_POSTER_SUCCESSFUL = "VIDEOS_UPLOAD_POSTER_SUCCESSFUL",
  VIDEOS_UPLOAD_POSTER_EMPTY_FILE = "VIDEOS_UPLOAD_POSTER_EMPTY_FILE",
  VIDEOS_UPLOAD_POSTER_IS_NULL = "VIDEOS_UPLOAD_POSTER_IS_NULL",
  VIDEOS_UPLOAD_POSTER_ERROR = "VIDEOS_UPLOAD_POSTER_ERROR",
  VIDEOS_UPLOAD_VIDEO_FILE_SUCCESSFUL = "VIDEOS_UPLOAD_VIDEO_FILE_SUCCESSFUL",
  VIDEOS_UPLOAD_VIDEO_FILE_EMPTY_FILE = "VIDEOS_UPLOAD_VIDEO_FILE_EMPTY_FILE",
  VIDEOS_UPLOAD_VIDEO_FILE_IS_NULL = "VIDEOS_UPLOAD_VIDEO_FILE_IS_NULL",
  VIDEOS_UPLOAD_VIDEO_FILE_ERROR = "VIDEOS_UPLOAD_VIDEO_FILE_ERROR",
  VIDEOS_UPDATE_VIDEO_STATE_SUCCESSFUL = "VIDEOS_UPDATE_VIDEO_STATE_SUCCESSFUL",
  VIDEOS_UPDATE_VIDEO_STATE_EMPTY_FORM_DATA = "VIDEOS_UPDATE_VIDEO_STATE_EMPTY_FORM_DATA",
  VIDEOS_UPDATE_VIDEO_STATE_IS_NULL = "VIDEOS_UPDATE_VIDEO_STATE_IS_NULL",
  VIDEOS_UPDATE_VIDEO_STATE_ERROR = "VIDEOS_UPDATE_VIDEO_STATE_ERROR",
