...
enum EServerResponses {
  ...
  VIDEOS_UPLOAD_FILE_AND_PASS_VALIDATION_POST_FILE_SUCCESSFUL = "VIDEOS_UPLOAD_FILE_AND_PASS_VALIDATION_POST_FILE_SUCCESSFUL",
  VIDEOS_UPLOAD_FILE_AND_PASS_VALIDATION_POST_BODY_SUCCESSFUL = "VIDEOS_UPLOAD_FILE_AND_PASS_VALIDATION_POST_BODY_SUCCESSFUL",
