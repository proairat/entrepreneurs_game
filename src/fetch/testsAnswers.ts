...
// id_question 1
testsAnswers.set(1, [
  { id: 1, answer: "2004", state: EEntityState.Unlocked },
  { id: 2, answer: "1998", state: EEntityState.Unlocked },
  { id: 3, answer: "2000", state: EEntityState.Unlocked },
  { id: 4, answer: "2002", state: EEntityState.Unlocked },
]);
...
// id_question 3
testsAnswers.set(3, [
  { id: 11, answer: "6%", state: EEntityState.Unlocked },
  { id: 12, answer: "8%", state: EEntityState.Unlocked },
  { id: 13, answer: "4%", state: EEntityState.Unlocked },
  { id: 14, answer: "10%", state: EEntityState.Unlocked },
]);
...
// id_question 6
testsAnswers.set(6, [
  { id: 22, answer: "Нет", state: EEntityState.Unlocked },
  { id: 23, answer: "Да", state: EEntityState.Unlocked },
]);
...
// id_question 9
testsAnswers.set(9, [
  { id: 32, answer: "Да", state: EEntityState.Unlocked },
  { id: 33, answer: "Нет", state: EEntityState.Unlocked },
]);
...
// id_question 11
testsAnswers.set(11, [
  { id: 37, answer: "4", state: EEntityState.Unlocked },
  { id: 38, answer: "5", state: EEntityState.Unlocked },
  { id: 39, answer: "6", state: EEntityState.Unlocked },
  { id: 40, answer: "7", state: EEntityState.Unlocked },
  { id: 41, answer: "8", state: EEntityState.Unlocked },
  { id: 42, answer: "9", state: EEntityState.Unlocked },
  { id: 43, answer: "10", state: EEntityState.Unlocked },
  { id: 44, answer: "11", state: EEntityState.Unlocked },
  { id: 45, answer: "12", state: EEntityState.Unlocked },
]);
...
// id_question 13
testsAnswers.set(13, [
  { id: 49, answer: "Да", state: EEntityState.Unlocked },
  { id: 50, answer: "Нет", state: EEntityState.Unlocked },
]);
