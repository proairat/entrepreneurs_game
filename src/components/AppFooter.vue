<template>
  <footer class="text-center lg:text-left bg-indigo-100 text-indigo-900">
    <div class="mx-6 pt-6 text-center md:text-left">
      <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div class="">
          ...
          >
            <img
              class="h-11 w-[105px] academicCap"
          ...
          <p>
            Веб-платформа с курсами по предпринимательству с игрофикацией,
            тестами остаточных знаний и системой ввода образовательного контента
          </p>
        </div>
        <div class="">
          <h6
    ...
    <div class="text-center p-6 bg-indigo-100 text-indigo-900">
      <a href="https://tailwind-elements.com/"
        >© Игровая платформа по развитию предпринимательства, 2022</a
      >
    </div>
  </footer>
</template>
